...
public class FareCalculatorServiceTest {
	...
	public void calculateFareBikeWithLessThanOneHourParkingTime() {
		...
		Date inTime = new Date(nowTime.getTime() - (45 * 60 * 1000)); // 45 minutes parking time should give 3/4th parking fare 
		Date outTime = new Date(nowTime.getTime());
		ParkingSpot parkingSpot = new ParkingSpot(1, ParkingType.BIKE, false);
	...
	public void calculateFareCarWithMoreThanADayParkingTime() {
		...
		Date inTime = new Date(nowTime.getTime() - (24 * 60 * 60 * 1000)); // 24 hours parking time should give 24 * parking fare per hour 
		Date outTime = new Date(nowTime.getTime());
		ParkingSpot parkingSpot = new ParkingSpot(1, ParkingType.CAR, false);
