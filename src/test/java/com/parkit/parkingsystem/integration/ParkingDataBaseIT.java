...
public class ParkingDataBaseIT {
    ...
    public void testParkingACar(){
        try {
	        ...
	        ResultSet rs = connection.prepareStatement("select t.VEHICLE_REG_NUMBER from ticket t where t.VEHICLE_REG_NUMBER='ABCDEF'").executeQuery();
